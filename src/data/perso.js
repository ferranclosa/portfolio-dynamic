const perso = [
    ...
    ,
    {
        ...
        details: [
            { title: "Spanish", description: "This was an accident, but a happy one. I have lived a great number of years in other countries, but Spain remains my land, my people, my roots. You English have a wonderful word for that: Home." },
            { title: "Musician", description: "My early beginnings where passionately around music. Specially the violin, which for me, holds a magical and mystic element that, in my case it does last." },
            { title: "IT professional", description: "Another lucky accident. What attracted me, in principle, was curiosity and soon, the creative capacities that are associated with it, such as the fact of creating something from an idea, with no more tools than the adoption and combination of different algorithms. This is the part of my work which I enjoy the most and that gives me the most pleasure." },
    ...
    ,
    {
        ...
        details: [
            { title: "Espagnol", subtitle: "", description: "C’était un accident, mais un accident chanceux. J’ai vécu une grande partie de ma vie dans d’autres endroits, mais chez moi c'est toujours ma terre, mon peuple et mes lieux." },
            { title: "Musicien", subtitle: "", description: "De très petit, j’étais passionné pour la musique et le violon. Cette capacité de vocation est restée ancrée dans ma personnalité." },
    ...
    ,
    {
        ...
        details: [
            ...
            { title: "Músic", subtitle: "", description: "De petit, molt aviat, vaig tenir una votació cap a la música i el violí. Aquesta capacitat de vocació ha quedat incrustada en la meva personalitat" },
